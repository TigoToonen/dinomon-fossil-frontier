...
DG.SpriteRenderer = (function () {
  ...
  const _ARCHETYPE_MAP = {
    ...
    GEMLET:'FAIRY',GEMHORN:'FAIRY',PRISMACERA:'FAIRY',
    WISPLET:'FAIRY',FLUTTERHORN:'FAIRY',SERAPHWING:'FAIRY',
    // Fossil DinoMon
    AMBERLITE:'BUG',AMBERWING:'BUG',
    TARCLAW:'RAPTOR',TARRASAUR:'RAPTOR',
    CRYOSHELL:'ANKYLO',CRYOSAUR:'ANKYLO',
    NAUTILON:'AQUA',ABYSSHELL:'AQUA',
    AEROLITH:'PTERO',AERODON:'PTERO',
  ...
  const _STAGE_MAP = {
    ...
    GEMLET:0,WISPLET:0,
    AMBERLITE:0,TARCLAW:0,CRYOSHELL:0,NAUTILON:0,AEROLITH:0,
    ...
    PRISMACERA:2,SERAPHWING:2,
    AMBERWING:2,TARRASAUR:2,CRYOSAUR:2,ABYSSHELL:2,AERODON:2,
  ...
  const _VARIANT_MAP = {
    ...
    GEMLET:0,GEMHORN:0,PRISMACERA:0,
    WISPLET:0,FLUTTERHORN:0,SERAPHWING:0,
    AMBERLITE:0,AMBERWING:0,TARCLAW:0,TARRASAUR:0,CRYOSHELL:0,CRYOSAUR:0,
    NAUTILON:0,ABYSSHELL:0,AEROLITH:0,AERODON:0,
