...
DG.MOVES = {
  ...
  TOXIC: {
    ...
    priority: 0,
    animStyle: 'FIELD',
    // BATTLE-STRATEGY Fase 1a: was per ongeluk gewone POISON — de omschrijving
    // beloofde al escalerend gif, nu doet hij dat ook echt.
  ...
  MIND_DIVE: {
    ...
    accuracy: 100,
    pp: 10,
    // BATTLE-STRATEGY Fase 2c: was prio 1 bij 95 power — sterker dan elke
    // klassieke priority-move; de vanguard van DRAGON is nu Tail Feint.
    priority: 0,
    animStyle: 'SLAM',
    effect: { type: 'NONE' },
    description: 'The user dives into the foe\'s psyche with overwhelming draconic force.'
  },
  ...
  PLATE_SLAM: {
    ...
    accuracy: 100,
    pp: 15,
    // Fase 2c: prio 1 → 0 (80 power hoort niet eerst te slaan); GRASS-vanguard = Leaf Dart
    priority: 0,
    animStyle: 'CONE',
    effect: { type: 'NONE' },
    description: 'The user charges with its armored plates leading in a reinforced strike.'
  },
  ...
  SUCKER_PUNCH: {
    ...
    // Fase 2a: de klassieke conditie is nu echt — faalt als het doelwit geen
    // aanval koos. Hoog risico, hoge beloning: dé DARK-vanguard.
    effect: { type: 'SUCKER' },
  ...
  SUPERSONIC_STRIKE: {
    ...
    power:70, accuracy:95, pp:15, priority:0, animStyle:'PROJECTILE',
    effect:{type:'NONE'},
    description:'The user dives at the target with devastating supersonic speed.'
  },
...
LAVA_SURGE: { id:'LAVA_SURGE', name:'Lava Surge', type:'FIRE', category:'SPECIAL', power:85, accuracy:90, pp:10, priority:0, animStyle:'BURST',
    effect:{type:'STATUS_CHANCE', status:'BURN', chance:30}, description:'A surge of lava erupts upward. May burn the foe.' },
  ...
  MAGMA_RAIN: { id:'MAGMA_RAIN', name:'Magma Rain', type:'FIRE', category:'SPECIAL', power:90, accuracy:85, pp:10, priority:0, animStyle:'MULTI',
    effect:{type:'STATUS_CHANCE', status:'BURN', chance:20}, description:'Molten rock rains down on all foes. May burn.' },
  EMBER_STORM: { id:'EMBER_STORM', name:'Ember Storm', type:'FIRE', category:'SPECIAL', power:60, accuracy:100, pp:20, priority:0, animStyle:'VORTEX',
    effect:{type:'STATUS_CHANCE', status:'BURN', chance:15}, description:'A swirling storm of embers engulfs the foe.' },
  SCORCHING_BREATH: { id:'SCORCHING_BREATH', name:'Scorching Breath', type:'FIRE', category:'SPECIAL', power:75, accuracy:95, pp:15, priority:0, animStyle:'CONE',
    effect:{type:'STATUS_CHANCE', status:'BURN', chance:25}, description:'Searing breath scorches the foe. May cause a burn.' },
  ...
  EMBER_CLAW: { id:'EMBER_CLAW', name:'Ember Claw', type:'FIRE', category:'PHYSICAL', power:55, accuracy:100, pp:20, priority:0, animStyle:'MELEE',
    effect:{type:'STATUS_CHANCE', status:'BURN', chance:20}, description:'Claws blazing with fire slash the foe.' },
  ...
  CHAR_PULSE: { id:'CHAR_PULSE', name:'Char Pulse', type:'FIRE', category:'SPECIAL', power:65, accuracy:100, pp:15, priority:0, animStyle:'PULSE',
    effect:{type:'STATUS_CHANCE', status:'BURN', chance:10}, description:'A pulse of charring energy radiates outward.' },
  MAGMA_FIST: { id:'MAGMA_FIST', name:'Magma Fist', type:'FIRE', category:'PHYSICAL', power:85, accuracy:95, pp:10, priority:0, animStyle:'MELEE',
    effect:{type:'STATUS_CHANCE', status:'BURN', chance:30}, description:'A punch wrapped in magma scorches on impact.' },
  ...
  BURNING_COMET: { id:'BURNING_COMET', name:'Burning Comet', type:'FIRE', category:'SPECIAL', power:100, accuracy:90, pp:10, priority:0, animStyle:'PROJECTILE',
    effect:{type:'STATUS_CHANCE', status:'BURN', chance:20}, description:'A blazing comet of condensed fire crashes down.' },
  ...
  SMOLDER: { id:'SMOLDER', name:'Smolder', type:'FIRE', category:'STATUS', power:0, accuracy:100, pp:30, priority:0, animStyle:'FIELD',
    effect:{type:'STATUS_CHANCE', status:'BURN', chance:100}, description:'Sets the foe ablaze with a steady, persistent flame.' },
  ...
  FLAME_TORNADO: { id:'FLAME_TORNADO', name:'Flame Tornado', type:'FIRE', category:'SPECIAL', power:95, accuracy:85, pp:10, priority:0, animStyle:'VORTEX',
    effect:{type:'STATUS_CHANCE', status:'BURN', chance:30}, description:'A spinning funnel of fire traps the foe.' },
  ...
  PYRE_WAVE: { id:'PYRE_WAVE', name:'Pyre Wave', type:'FIRE', category:'SPECIAL', power:80, accuracy:95, pp:10, priority:0, animStyle:'WAVE',
    effect:{type:'STATUS_CHANCE', status:'BURN', chance:25}, description:'A wave of funeral fire rolls over the battlefield.' },
  ...
  SALTWATER_SURGE: { id:'SALTWATER_SURGE', name:'Saltwater Surge', type:'WATER', category:'SPECIAL', power:70, accuracy:100, pp:15, priority:0, animStyle:'BURST',
    effect:{type:'STATUS_CHANCE', status:'BURN', chance:10}, description:'Stinging saltwater blasts sting like fire.' },
  ...
  WATER_FANG: { id:'WATER_FANG', name:'Water Fang', type:'WATER', category:'PHYSICAL', power:65, accuracy:95, pp:15, priority:0, animStyle:'MELEE',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:10}, description:'Watery fangs may paralyze on impact.' },
  ...
  FROZEN_TIDE: { id:'FROZEN_TIDE', name:'Frozen Tide', type:'WATER', category:'SPECIAL', power:85, accuracy:90, pp:10, priority:0, animStyle:'WAVE',
    effect:{type:'STATUS_CHANCE', status:'FREEZE', chance:10}, description:'Supercooled tidal water may freeze the foe.' },
  RIVER_RUSH: { id:'RIVER_RUSH', name:'River Rush', type:'WATER', category:'PHYSICAL', power:70, accuracy:100, pp:15, priority:0, animStyle:'WAVE',
  ...
  SPORE_CLOUD: { id:'SPORE_CLOUD', name:'Spore Cloud', type:'GRASS', category:'STATUS', power:0, accuracy:90, pp:15, priority:0, animStyle:'FIELD',
    effect:{type:'STATUS_CHANCE', status:'SLEEP', chance:100}, description:'A dense cloud of sleep spores settles on the foe.' },
  ...
  ROOT_BIND: { id:'ROOT_BIND', name:'Root Bind', type:'GRASS', category:'STATUS', power:0, accuracy:90, pp:20, priority:0, animStyle:'FIELD',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:100}, description:'Underground roots burst up and bind the foe.' },
  ...
  VOLTAGE_CRASH: { id:'VOLTAGE_CRASH', name:'Voltage Crash', type:'ELECTRIC', category:'PHYSICAL', power:90, accuracy:95, pp:10, priority:0, animStyle:'SLAM',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:20}, description:'Crashes into the foe with electrified body.' },
  CHAIN_LIGHTNING: { id:'CHAIN_LIGHTNING', name:'Chain Lightning', type:'ELECTRIC', category:'SPECIAL', power:70, accuracy:100, pp:15, priority:0, animStyle:'MULTI',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:30}, description:'Lightning chains across multiple targets.' },
  ...
  PLASMA_BURST: { id:'PLASMA_BURST', name:'Plasma Burst', type:'ELECTRIC', category:'SPECIAL', power:85, accuracy:95, pp:10, priority:0, animStyle:'BURST',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:20}, description:'Superheated plasma bursts around the foe.' },
  STATIC_FIELD: { id:'STATIC_FIELD', name:'Static Field', type:'ELECTRIC', category:'STATUS', power:0, accuracy:100, pp:20, priority:0, animStyle:'FIELD',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:100}, description:'Creates a static field that paralyzes the foe.' },
  SPARK_SHOWER: { id:'SPARK_SHOWER', name:'Spark Shower', type:'ELECTRIC', category:'SPECIAL', power:55, accuracy:100, pp:20, priority:0, animStyle:'MULTI',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:10}, description:'A shower of sparks strikes 2-5 times.' },
  ...
  THUNDER_FIST: { id:'THUNDER_FIST', name:'Thunder Fist', type:'ELECTRIC', category:'PHYSICAL', power:85, accuracy:100, pp:10, priority:0, animStyle:'MELEE',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:30}, description:'An electrified punch that may cause paralysis.' },
  ...
  VOLT_CRASH: { id:'VOLT_CRASH', name:'Volt Crash', type:'ELECTRIC', category:'PHYSICAL', power:100, accuracy:90, pp:10, priority:0, animStyle:'SLAM',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:30}, description:'Crashes with massive electrical voltage.' },
  ARC_FLASH: { id:'ARC_FLASH', name:'Arc Flash', type:'ELECTRIC', category:'SPECIAL', power:60, accuracy:100, pp:20, priority:0, animStyle:'ARC',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:30}, description:'A bright arc of electricity may paralyze.' },
  ...
  BOLT_STRIKE: { id:'BOLT_STRIKE', name:'Bolt Strike', type:'ELECTRIC', category:'PHYSICAL', power:130, accuracy:85, pp:5, priority:0, animStyle:'BEAM',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:20}, description:'A lightning-speed strike of immense power.' },
  ...
  TESLA_BLAST: { id:'TESLA_BLAST', name:'Tesla Blast', type:'ELECTRIC', category:'SPECIAL', power:90, accuracy:95, pp:10, priority:0, animStyle:'BURST',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:20}, description:'A blast of Tesla-coil electricity shocks the foe.' },
  ...
  ZAP_BURST: { id:'ZAP_BURST', name:'Zap Burst', type:'ELECTRIC', category:'SPECIAL', power:50, accuracy:100, pp:25, priority:0, animStyle:'BURST',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:20}, description:'Quick zap of electricity. May paralyze.' },
  STORMFRONT: { id:'STORMFRONT', name:'Stormfront', type:'ELECTRIC', category:'SPECIAL', power:95, accuracy:90, pp:10, priority:0, animStyle:'VORTEX',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:30}, description:'Summons a storm front that electrifies the field.' },
  ...
  SPARK_TRAIL: { id:'SPARK_TRAIL', name:'Spark Trail', type:'ELECTRIC', category:'PHYSICAL', power:60, accuracy:100, pp:20, priority:0, animStyle:'ARC',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:20}, description:'Leaves a trail of sparks that shocks the foe.' },
  ...
  FROST_LANCE: { id:'FROST_LANCE', name:'Frost Lance', type:'ICE', category:'PHYSICAL', power:75, accuracy:100, pp:15, priority:0, animStyle:'BEAM',
    effect:{type:'STATUS_CHANCE', status:'FREEZE', chance:10}, description:'A lance of ice hurled at the foe.' },
  SNOWSTORM: { id:'SNOWSTORM', name:'Snowstorm', type:'ICE', category:'SPECIAL', power:85, accuracy:90, pp:10, priority:0, animStyle:'VORTEX',
    effect:{type:'STATUS_CHANCE', status:'FREEZE', chance:20}, description:'A raging snowstorm blasts the foe.' },
  CRYO_BEAM: { id:'CRYO_BEAM', name:'Cryo Beam', type:'ICE', category:'SPECIAL', power:100, accuracy:90, pp:10, priority:0, animStyle:'BEAM',
    effect:{type:'STATUS_CHANCE', status:'FREEZE', chance:30}, description:'A beam of cryogenic energy may freeze the foe.' },
  ...
  BLIZZARD_BLADE: { id:'BLIZZARD_BLADE', name:'Blizzard Blade', type:'ICE', category:'PHYSICAL', power:80, accuracy:100, pp:10, priority:0, animStyle:'MELEE',
    effect:{type:'STATUS_CHANCE', status:'FREEZE', chance:20}, description:'A blade sharpened to arctic cold.' },
  ICE_SPIKE: { id:'ICE_SPIKE', name:'Ice Spike', type:'ICE', category:'PHYSICAL', power:50, accuracy:100, pp:25, priority:0, animStyle:'PROJECTILE',
    effect:{type:'STATUS_CHANCE', status:'FREEZE', chance:10}, description:'A sharp ice spike hurled at the foe.' },
  TUNDRA_WAVE: { id:'TUNDRA_WAVE', name:'Tundra Wave', type:'ICE', category:'SPECIAL', power:75, accuracy:100, pp:15, priority:0, animStyle:'WAVE',
    effect:{type:'STATUS_CHANCE', status:'FREEZE', chance:10}, description:'A wave of arctic air sweeps the battlefield.' },
  ...
  AURORA_BLAST: { id:'AURORA_BLAST', name:'Aurora Blast', type:'ICE', category:'SPECIAL', power:80, accuracy:95, pp:10, priority:0, animStyle:'ARC',
    effect:{type:'STATUS_CHANCE', status:'FREEZE', chance:15}, description:'Northern lights solidify into a freezing blast.' },
  FROSTBITE: { id:'FROSTBITE', name:'Frostbite', type:'ICE', category:'STATUS', power:0, accuracy:100, pp:20, priority:0, animStyle:'FIELD',
    effect:{type:'STATUS_CHANCE', status:'FREEZE', chance:100}, description:'Inflicts frostbite, freezing the foe solid.' },
  POLAR_VORTEX: { id:'POLAR_VORTEX', name:'Polar Vortex', type:'ICE', category:'SPECIAL', power:110, accuracy:85, pp:8, priority:0, animStyle:'VORTEX',
    effect:{type:'STATUS_CHANCE', status:'FREEZE', chance:30}, description:'A devastating polar vortex engulfs the field.' },
  FROST_BREATH_CHILL: { id:'FROST_BREATH_CHILL', name:'Frost Breath', type:'ICE', category:'SPECIAL', power:60, accuracy:90, pp:15, priority:0, animStyle:'CONE',
    effect:{type:'STATUS_CHANCE', status:'FREEZE', chance:30}, description:'Critical-hit-always frosty breath chills the foe.' },
  ...
  CRYO_PUNCH: { id:'CRYO_PUNCH', name:'Cryo Punch', type:'ICE', category:'PHYSICAL', power:75, accuracy:100, pp:15, priority:0, animStyle:'MELEE',
    effect:{type:'STATUS_CHANCE', status:'FREEZE', chance:20}, description:'An icy punch that may freeze on contact.' },
  ICE_BEAM_BURST: { id:'ICE_BEAM_BURST', name:'Glacier Beam', type:'ICE', category:'SPECIAL', power:95, accuracy:100, pp:10, priority:0, animStyle:'BEAM',
    effect:{type:'STATUS_CHANCE', status:'FREEZE', chance:20}, description:'A condensed beam of glacier-cold energy.' },
  ...
  AERIAL_BLITZ: { id:'AERIAL_BLITZ', name:'Aerial Blitz', type:'NORMAL', category:'PHYSICAL', power:70, accuracy:100, pp:15, priority:0, animStyle:'ARC',
  ...
  VENOM_BURST: { id:'VENOM_BURST', name:'Venom Burst', type:'POISON', category:'SPECIAL', power:85, accuracy:95, pp:10, priority:0, animStyle:'BURST',
    effect:{type:'STATUS_CHANCE', status:'POISON', chance:30}, description:'A burst of concentrated venom splashes the foe.' },
  ACID_RAIN: { id:'ACID_RAIN', name:'Acid Rain', type:'POISON', category:'SPECIAL', power:70, accuracy:90, pp:15, priority:0, animStyle:'MULTI',
    effect:{type:'STATUS_CHANCE', status:'POISON', chance:20}, description:'Acidic rain drops hit 2-5 times, may poison.' },
  TOXIC_SLAM: { id:'TOXIC_SLAM', name:'Toxic Slam', type:'POISON', category:'PHYSICAL', power:80, accuracy:100, pp:10, priority:0, animStyle:'SLAM',
    effect:{type:'STATUS_CHANCE', status:'POISON', chance:30}, description:'Slams with a poison-coated body.' },
  MIASMA_CLOUD: { id:'MIASMA_CLOUD', name:'Miasma Cloud', type:'POISON', category:'STATUS', power:0, accuracy:90, pp:15, priority:0, animStyle:'FIELD',
    effect:{type:'STATUS_CHANCE', status:'POISON', chance:100}, description:'A cloud of miasma poisons the foe.' },
  ...
  VENOM_STRIKE: { id:'VENOM_STRIKE', name:'Venom Strike', type:'POISON', category:'PHYSICAL', power:65, accuracy:100, pp:15, priority:0, animStyle:'MELEE',
    effect:{type:'STATUS_CHANCE', status:'POISON', chance:40}, description:'A venomous slash likely to poison.' },
  ACID_DOWNPOUR: { id:'ACID_DOWNPOUR', name:'Acid Downpour', type:'POISON', category:'SPECIAL', power:100, accuracy:90, pp:10, priority:0, animStyle:'BURST',
    effect:{type:'STATUS_CHANCE', status:'POISON', chance:20}, description:'A torrential downpour of acid crashes down.' },
  PUTRID_WAVE: { id:'PUTRID_WAVE', name:'Putrid Wave', type:'POISON', category:'SPECIAL', power:75, accuracy:100, pp:15, priority:0, animStyle:'WAVE',
    effect:{type:'STATUS_CHANCE', status:'POISON', chance:30}, description:'A rotting wave of foul energy sweeps the field.' },
  TOXIC_CLAW: { id:'TOXIC_CLAW', name:'Toxic Claw', type:'POISON', category:'PHYSICAL', power:55, accuracy:100, pp:20, priority:0, animStyle:'MELEE',
    effect:{type:'STATUS_CHANCE', status:'POISON', chance:50}, description:'Claws coated in toxin likely to poison.' },
  SLUDGE_SURGE: { id:'SLUDGE_SURGE', name:'Sludge Surge', type:'POISON', category:'SPECIAL', power:80, accuracy:90, pp:10, priority:0, animStyle:'WAVE',
    effect:{type:'STATUS_CHANCE', status:'POISON', chance:30}, description:'A surge of toxic sludge washes over the foe.' },
  PLAGUE_BREATH: { id:'PLAGUE_BREATH', name:'Plague Breath', type:'POISON', category:'SPECIAL', power:70, accuracy:100, pp:15, priority:0, animStyle:'CONE',
    effect:{type:'STATUS_CHANCE', status:'POISON', chance:30}, description:'Plague-filled breath exhaled in a wide cone.' },
  VIPER_LUNGE: { id:'VIPER_LUNGE', name:'Viper Lunge', type:'POISON', category:'PHYSICAL', power:90, accuracy:95, pp:10, priority:0, animStyle:'MELEE',
    effect:{type:'STATUS_CHANCE', status:'POISON', chance:20}, description:'Lunges like a viper for a venomous bite.' },
  ...
  VENOM_DRIP: { id:'VENOM_DRIP', name:'Venom Drip', type:'POISON', category:'SPECIAL', power:50, accuracy:100, pp:25, priority:0, animStyle:'PROJECTILE',
    effect:{type:'STATUS_CHANCE', status:'POISON', chance:40}, description:'Drips venom onto the foe. Likely to poison.' },
  TOXIC_SPINES: { id:'TOXIC_SPINES', name:'Toxic Spines', type:'POISON', category:'PHYSICAL', power:60, accuracy:95, pp:15, priority:0, animStyle:'MULTI',
    effect:{type:'STATUS_CHANCE', status:'POISON', chance:30}, description:'Fires toxic spines that may poison.' },
  NOXIOUS_CLOUD: { id:'NOXIOUS_CLOUD', name:'Noxious Cloud', type:'POISON', category:'SPECIAL', power:80, accuracy:90, pp:10, priority:0, animStyle:'VORTEX',
    effect:{type:'STATUS_CHANCE', status:'POISON', chance:50}, description:'A swirling noxious cloud heavily poisons the foe.' },
  VENOM_CANNON: { id:'VENOM_CANNON', name:'Venom Cannon', type:'POISON', category:'SPECIAL', power:110, accuracy:85, pp:8, priority:0, animStyle:'BEAM',
    effect:{type:'STATUS_CHANCE', status:'POISON', chance:20}, description:'Fires a concentrated beam of venom.' },
  ...
  QUICKSAND: { id:'QUICKSAND', name:'Quicksand', type:'GROUND', category:'STATUS', power:0, accuracy:90, pp:20, priority:0, animStyle:'FIELD',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:100}, description:'The foe sinks in quicksand, unable to move.' },
  ...
  GLIDE_STRIKE: { id:'GLIDE_STRIKE', name:'Glide Strike', type:'FLYING', category:'PHYSICAL', power:65, accuracy:100, pp:20, priority:0, animStyle:'ARC',
  ...
  TEMPEST_STRIKE: { id:'TEMPEST_STRIKE', name:'Tempest Strike', type:'FLYING', category:'SPECIAL', power:90, accuracy:90, pp:10, priority:0, animStyle:'BURST',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:20}, description:'The tempests force may paralyze the foe.' },
...
MIND_CRUSH: { id:'MIND_CRUSH', name:'Mind Crush', type:'PSYCHIC', category:'SPECIAL', power:85, accuracy:100, pp:10, priority:0, animStyle:'PULSE',
  ...
  NEURAL_BLAST: { id:'NEURAL_BLAST', name:'Neural Blast', type:'PSYCHIC', category:'SPECIAL', power:80, accuracy:95, pp:10, priority:0, animStyle:'BURST',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:20}, description:'Fires a neural burst that may cause paralysis.' },
  ...
  PETRIFACTION: { id:'PETRIFACTION', name:'Petrifaction', type:'ROCK', category:'STATUS', power:0, accuracy:80, pp:10, priority:0, animStyle:'FIELD',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:100}, description:'Turns the foes limbs to stone, paralyzing them.' },
  ...
  CRYSTAL_LANCE: { id:'CRYSTAL_LANCE', name:'Crystal Lance', type:'ROCK', category:'PHYSICAL', power:80, accuracy:100, pp:10, priority:0, animStyle:'MELEE',
    effect:{type:'STATUS_CHANCE', status:'FREEZE', chance:10}, description:'A lance of pure crystal may freeze on contact.' },
  ...
  AMBER_TRAP: { id:'AMBER_TRAP', name:'Amber Trap', type:'ROCK', category:'STATUS', power:0, accuracy:90, pp:15, priority:0, animStyle:'FIELD',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:100}, description:'Encases the foe in ancient amber.' },
  ...
  DARK_VOID: { id:'DARK_VOID', name:'Dark Void', type:'GHOST', category:'STATUS', power:0, accuracy:80, pp:10, priority:0, animStyle:'VORTEX',
    effect:{type:'STATUS_CHANCE', status:'SLEEP', chance:100}, description:'Pulls the foe into a dimension of endless sleep.' },
  ...
  CURSED_TOUCH: { id:'CURSED_TOUCH', name:'Cursed Touch', type:'GHOST', category:'PHYSICAL', power:65, accuracy:100, pp:15, priority:0, animStyle:'MELEE',
    effect:{type:'STATUS_CHANCE', status:'POISON', chance:30}, description:'A cursed hand poisons on contact.' },
  ...
  SHADOWSTEP: { id:'SHADOWSTEP', name:'Shadowstep', type:'GHOST', category:'PHYSICAL', power:60, accuracy:100, pp:20, priority:0, animStyle:'ARC',
  ...
  SERPENT_STRIKE: { id:'SERPENT_STRIKE', name:'Serpent Strike', type:'DRAGON', category:'PHYSICAL', power:65, accuracy:100, pp:20, priority:0, animStyle:'MELEE',
    effect:{type:'STATUS_CHANCE', status:'POISON', chance:20}, description:'A dragon-serpent bite may poison the foe.' },
  ...
  PRIMORDIAL_BREATH: { id:'PRIMORDIAL_BREATH', name:'Primordial Breath', type:'DRAGON', category:'SPECIAL', power:90, accuracy:90, pp:10, priority:0, animStyle:'CONE',
    effect:{type:'STATUS_CHANCE', status:'BURN', chance:20}, description:'The first flame breathed by the oldest dragons.' },
  ...
  ENDLESS_DEVOUR: { id:'ENDLESS_DEVOUR', name:'Endless Devour', type:'DARK', category:'PHYSICAL', power:120, accuracy:100, pp:5, priority:0, animStyle:'MELEE',
    effect:{type:'DRAIN',fraction:0.5}, description:'MEGAVORE’s signature. The Endless Hunger devours the foe, restoring the user by half the damage dealt.' },
  MAGMA_THRONE: { id:'MAGMA_THRONE', name:'Magma Throne', type:'FIRE', category:'PHYSICAL', power:110, accuracy:100, pp:5, priority:0, animStyle:'MELEE',
    effect:{type:'STATUS_CHANCE',status:'BURN',chance:30}, description:'TITANREX’s signature. The volcanic king erupts from its throne — a 30% chance to leave the target badly burned.' },
  ...
  MAGNETISM: { id:'MAGNETISM', name:'Magnetism', type:'STEEL', category:'STATUS', power:0, accuracy:100, pp:20, priority:0, animStyle:'FIELD',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:100}, description:'Magnetizes the foes metallic parts, paralyzing them.' },
  ...
  IRON_CAGE: { id:'IRON_CAGE', name:'Iron Cage', type:'STEEL', category:'STATUS', power:0, accuracy:90, pp:15, priority:0, animStyle:'FIELD',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:100}, description:'An iron cage traps the foe, preventing escape.' },
  ...
  VENOM_STING_PLUS: { id:'VENOM_STING_PLUS', name:'Venom Sting', type:'BUG', category:'PHYSICAL', power:55, accuracy:100, pp:20, priority:0, animStyle:'PROJECTILE',
    effect:{type:'STATUS_CHANCE', status:'POISON', chance:50}, description:'A highly venomous sting likely to poison.' },
  ...
  ANTENNA_WAVE: { id:'ANTENNA_WAVE', name:'Antenna Wave', type:'BUG', category:'SPECIAL', power:60, accuracy:100, pp:20, priority:0, animStyle:'WAVE',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:20}, description:'Antenna-generated waves may paralyze.' },
  ...
  LARVA_BLAST: { id:'LARVA_BLAST', name:'Larva Blast', type:'BUG', category:'SPECIAL', power:75, accuracy:100, pp:15, priority:0, animStyle:'PROJECTILE',
    effect:{type:'STATUS_CHANCE', status:'POISON', chance:20}, description:'Blasts corrosive larval fluid that may poison.' },
...
ETHEREAL_SLASH: { id:'ETHEREAL_SLASH', name:'Ethereal Slash', type:'GHOST', category:'PHYSICAL', power:80, accuracy:100, pp:15, priority:0, animStyle:'MELEE',
  ...
  GHOUL_CLAW: { id:'GHOUL_CLAW', name:'Ghoul Claw', type:'GHOST', category:'PHYSICAL', power:60, accuracy:100, pp:20, priority:0, animStyle:'MELEE',
    effect:{type:'STATUS_CHANCE', status:'POISON', chance:20}, description:'Ghoulish claws may infect the foe with poison.' },
  ...
  PHANTOM_CLAW: { id:'PHANTOM_CLAW', name:'Phantom Claw', type:'GHOST', category:'PHYSICAL', power:65, accuracy:100, pp:20, priority:0, animStyle:'MELEE',
  ...
  SWIFT_WING: { id:'SWIFT_WING', name:'Swift Wing', type:'FLYING', category:'PHYSICAL', power:45, accuracy:100, pp:25, priority:1, animStyle:'ARC',
  ...
  STORM_SLAM: { id:'STORM_SLAM', name:'Storm Slam', type:'FLYING', category:'PHYSICAL', power:90, accuracy:90, pp:10, priority:0, animStyle:'SLAM',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:30}, description:'A slam charged with storm electricity may paralyze.' },
  ...
  DREAMBEAM: { id:'DREAMBEAM', name:'Dreambeam', type:'FAIRY', category:'SPECIAL', power:85, accuracy:100, pp:10, priority:0, animStyle:'BEAM',
    effect:{type:'STATUS_CHANCE', status:'SLEEP', chance:10}, description:'A beam of dream energy may put the foe to sleep.' },
  ...
  FAIRY_FLAME: { id:'FAIRY_FLAME', name:'Fairy Flame', type:'FAIRY', category:'SPECIAL', power:65, accuracy:100, pp:20, priority:0, animStyle:'BURST',
    effect:{type:'STATUS_CHANCE', status:'BURN', chance:10}, description:'Magical fairy flame may inflict a burn.' },
  ...
  PIXIE_STRIKE: { id:'PIXIE_STRIKE', name:'Pixie Strike', type:'FAIRY', category:'PHYSICAL', power:45, accuracy:100, pp:25, priority:1, animStyle:'MELEE',
  ...
  STINGER: { id:'STINGER', name:'Stinger', type:'BUG', category:'PHYSICAL', power:70, accuracy:100, pp:15, priority:0, animStyle:'PROJECTILE',
    effect:{type:'STATUS_CHANCE', status:'POISON', chance:30}, description:'A precision stinger strike may poison.' },
  ...
  SKITTER: { id:'SKITTER', name:'Skitter', type:'BUG', category:'PHYSICAL', power:45, accuracy:100, pp:20, priority:1, animStyle:'ARC',
  ...
  SILK_BIND: { id:'SILK_BIND', name:'Silk Bind', type:'BUG', category:'STATUS', power:0, accuracy:90, pp:15, priority:0, animStyle:'FIELD',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:100}, description:'Wraps the foe in thick silk, paralyzing them.' },
  ...
  METALLIC_PULSE: { id:'METALLIC_PULSE', name:'Metallic Pulse', type:'STEEL', category:'SPECIAL', power:80, accuracy:100, pp:10, priority:0, animStyle:'PULSE',
    effect:{type:'STATUS_CHANCE', status:'PARALYSIS', chance:20}, description:'Metal resonance may paralyze the foe.' },
  ...
  FLAME_PULSE: { id:'FLAME_PULSE', name:'Flame Pulse', type:'FIRE', category:'SPECIAL', power:65, accuracy:100, pp:20, priority:0, animStyle:'PULSE',
    effect:{type:'STATUS_CHANCE', status:'BURN', chance:20}, description:'Pulses of fire energy may burn the foe.' },
...
// ── BATTLE-STRATEGY Fase 2b: vanguard-moves ─────────────────────
// Per type één priority-aanval (prio +1, power 40-45, 100% acc, géén
// secundair effect). Deze zes vullen de typen die er nog geen hadden:
// GROUND, PSYCHIC, POISON, ELECTRIC, GRASS en DRAGON.
Object.assign(DG.MOVES, {
  MUD_DART:   { id:'MUD_DART', name:'Mud Dart', type:'GROUND', category:'PHYSICAL', power:40, accuracy:100, pp:20, priority:1, animStyle:'PROJECTILE', effect:{ type:'NONE' }, description:'A lightning-fast flick of hardened mud. Always strikes first.' },
  MIND_FLICK: { id:'MIND_FLICK', name:'Mind Flick', type:'PSYCHIC', category:'SPECIAL', power:40, accuracy:100, pp:20, priority:1, animStyle:'AURA', effect:{ type:'NONE' }, description:'A snap of psychic force that arrives before the foe can move.' },
  VENOM_DART: { id:'VENOM_DART', name:'Venom Dart', type:'POISON', category:'PHYSICAL', power:40, accuracy:100, pp:20, priority:1, animStyle:'PROJECTILE', effect:{ type:'NONE' }, description:'A needle-quick venomous jab. Always strikes first.' },
  STATIC_JAB: { id:'STATIC_JAB', name:'Static Jab', type:'ELECTRIC', category:'PHYSICAL', power:40, accuracy:100, pp:20, priority:1, animStyle:'MELEE', effect:{ type:'NONE' }, description:'A crackling jab faster than thought. Always strikes first.' },
  LEAF_DART:  { id:'LEAF_DART', name:'Leaf Dart', type:'GRASS', category:'PHYSICAL', power:40, accuracy:100, pp:20, priority:1, animStyle:'PROJECTILE', effect:{ type:'NONE' }, description:'A razor leaf flicked with blinding speed. Always strikes first.' },
  TAIL_FEINT: { id:'TAIL_FEINT', name:'Tail Feint', type:'DRAGON', category:'PHYSICAL', power:40, accuracy:100, pp:20, priority:1, animStyle:'ARC', effect:{ type:'NONE' }, description:'A deceptive tail swipe that lands before the foe reacts.' },
});
