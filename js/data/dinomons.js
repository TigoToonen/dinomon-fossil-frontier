...
TINDRAK: _sp('TINDRAK','Tindrak',['FIRE'],
  ...
  'PYROCERATH',36,'TINDREL','Ember Scales','Burns foes that make contact (10%)',
...
FERNASAUR: _sp('FERNASAUR','Fernasaur',['GRASS'],
  ...
  'VERDANTHORN',36,'LEAFAWN','Overgrow','Grass moves +50% when HP below 33%',
  45,142,'MEDIUM',false,false,
...
PLESIWAVE: _sp('PLESIWAVE','Plesiwave',['WATER'],
  ...
  'TIDANOSAURUS',36,'AQUEEL','Torrent','Water moves +50% when HP below 33%',
  45,142,'MEDIUM',false,false,
...
(function() {
  const _dex = {
    ...
    JUNGLESAUR:   { desc: 'The jungle itself moves when Junglesaur walks. Its roar shakes leaves from a kilometre away.', habitat: 'Evolves from Sprigdon at Lv.33' },
    // Mid-game
