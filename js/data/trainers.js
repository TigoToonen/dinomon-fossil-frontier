...
DG.TRAINERS.ELITE_AURORA = {
  ...
  isStoryBoss:        false,
  badge:              null,
  preBattleDialogue:  ["I am Aurora — first of the Elite Four.", 'The deep currents of time run frozen and bottomless... and so shall you.'],
  postBattleDialogue: ['The eternal ice cracks before you. The depths acknowledge a worthy soul. Proceed.'],
  winDialogue:        'The tides closed over your head. Return when your spirit no longer melts.',
  loseDialogue:       'Unthinkable... my endless winter, undone by your hand. Go on, then.',
  reward:             6250,
  party: [
    { speciesId: 'CRYOPHIN',    level: 75, moves: ['SURF', 'ICE_SHARD', 'AQUA_JET', 'CONFUSION'] },
    { speciesId: 'GLACIOHORN',  level: 78, moves: ['ICE_BEAM', 'SURF', 'PSYCHIC_MOVE', 'CRYSTAL_BEAM'] },
    { speciesId: 'PERMAFROST',  level: 80, moves: ['BLIZZARD', 'HYDRO_PUMP', 'PSYCHIC_MOVE', 'GLACIAL_MIND'] },
  ],
  aiTier: 3,
...
DG.TRAINERS.ELITE_EMBER = {
  ...
  isStoryBoss:        false,
  badge:              null,
  preBattleDialogue:  ["Ember of the Elite Four stands in your path.", 'Determination is a spark. I am the inferno that devours sparks whole!'],
  postBattleDialogue: ['Astonishing — my flames bowed to yours. Forge onward, blazing one.'],
  winDialogue:        'Snuffed out. Gather your embers and dare to face me again.',
  loseDialogue:       'Your fire outburned the sun itself. A legend in the making.',
  reward:             7500,
  party: [
    { speciesId: 'SCORCHBACK',  level: 78, moves: ['FLAMETHROWER', 'ROCK_SLIDE', 'FIRE_BLAST', 'SAIL_BLAST'] },
    { speciesId: 'PYROCERATH',  level: 80, moves: ['FLAMETHROWER', 'DRAGON_CLAW', 'ERUPTION_HORN', 'OVERHEAT'] },
    { speciesId: 'LAVACLAW',    level: 83, moves: ['FIRE_BLAST', 'EARTHQUAKE', 'FLAMETHROWER', 'SUNNY_DAY'] },
  ],
  aiTier: 3,
  location: 'FOSSIL_CITADEL',
};
...
DG.TRAINERS.ELITE_GARNET = {
  ...
  isStoryBoss:        false,
  badge:              null,
  preBattleDialogue:  ["Garnet of the Elite Four — unmoved for a thousand years.", 'The earth has outlasted every challenger. Prove you weigh more than dust.'],
  postBattleDialogue: ['The bedrock yields... and bedrock yields to no one. Remarkable. Move on.'],
  winDialogue:        'Crushed beneath the mountain. Dig deeper, then come again.',
  loseDialogue:       'Even mountains crumble for the chosen. Pass, worthy one.',
  reward:             8750,
  party: [
    { speciesId: 'TERRADON',    level: 80, moves: ['EARTHQUAKE', 'STONE_EDGE', 'CLUB_SMASH', 'STEALTH_ROCK'] },
    { speciesId: 'OSSIFANG',    level: 83, moves: ['SKULL_SLAM', 'EARTHQUAKE', 'STONE_EDGE', 'IRON_DEFENSE'] },
    { speciesId: 'MEGASTONE',   level: 85, moves: ['STONE_EDGE', 'EARTHQUAKE', 'ROCK_SLIDE', 'ANCIENT_POWER'] },
  ],
  aiTier: 3,
  location: 'FOSSIL_CITADEL',
};
...
DG.TRAINERS.ELITE_PHANTOM = {
  ...
  isStoryBoss:        false,
  badge:              null,
  preBattleDialogue:  ["Phantom of the Elite Four — the last shadow before the throne.", 'Beyond me waits the Champion. But first, you must conquer your own darkness.'],
  postBattleDialogue: ['You pierced the veil itself. The Champion awaits — if your courage holds.'],
  winDialogue:        'The dark swallowed you whole. Return when shadows no longer frighten you.',
  loseDialogue:       'The veil parts for you, and you alone. Go — claim your destiny.',
  reward:             10000,
  party: [
    { speciesId: 'NIGHTREX',    level: 83, moves: ['CRUNCH', 'DARK_PULSE', 'NIGHT_SLASH', 'CLOSE_COMBAT'] },
    { speciesId: 'PHANTOSAUR',  level: 85, moves: ['SHADOW_CLAW', 'DRAGON_PULSE', 'PHANTOM_FORCE', 'HEX'] },
    { speciesId: 'OBSIDIUDON',  level: 88, moves: ['SHADOW_BALL', 'DARK_PULSE', 'DRAGON_DANCE', 'OUTRAGE'] },
  ],
  aiTier: 3,
  location: 'FOSSIL_CITADEL',
};
...
DG.TRAINERS.GRAND_ARCHON_CORVUS = {
  ...
  reward:             30000, // largest payout in the game — the climax
  spriteKey:          'NPC_LEADER',
  party: [
    { speciesId: 'SKYFANG',      level: 88, moves: ['DRAGON_PULSE','AERIAL_ACE','DRAGON_CLAW','PSYCHIC'] },
    { speciesId: 'TITANOSAUR',   level: 90, moves: ['IRON_HEAD','BODY_SLAM','EARTHQUAKE','IRON_DEFENSE'] },
    { speciesId: 'OBSIDIUDON',   level: 90, moves: ['SHADOW_BALL','CRUNCH','DRAGON_PULSE','DARK_PULSE'] },
    { speciesId: 'PYROCERATH',   level: 92, moves: ['FLAMETHROWER','DRAGON_CLAW','FLARE_BLITZ','CRUNCH'] },
    { speciesId: 'GLACIODON',    level: 93, moves: ['SURF','PSYCHIC','ICE_BEAM','BLIZZARD'] },
    { speciesId: 'CRATERON',     level: 95, moves: ['FLAMETHROWER','DRAGON_CLAW','CRUNCH','FIRE_BLAST'] },
  ],
  aiTier:   3,
  location: 'FOSSIL_CITADEL',
};
